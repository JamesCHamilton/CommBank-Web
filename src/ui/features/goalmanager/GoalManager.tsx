...
export function GoalManager(props: Props) {
  ...
  const pickEmojiOnClick = (emoji: BaseEmoji, event: React.MouseEvent<HTMLDivElement>) => {
  ...
  return (
    ...
    <EmojiPickerContainer
      ...
      <AddIconButtonText hasIcon={hasIcon()}>{goal.icon}</AddIconButtonText>
...
type AddIconButtonTextProps = {hasIcon : boolean}
...
`
const AddIconButtonText = styled.div<AddIconButtonTextProps>`
